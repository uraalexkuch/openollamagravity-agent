...
class AgentLoop {
    ...
    clearHistory() { this._history = []; this._loadedFolders.clear(); client_1.oogLogger.appendLine('[Agent] Історію очищено.'); }
    ...
    async _streamWithTimeout(step, total, signal) {
        const ms = vscode.workspace.getConfiguration('openollamagravity').get('firstTokenTimeoutSec', 180) * 1000;
